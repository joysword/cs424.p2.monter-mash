class ys_Range {
  ...
  public float getY_Low() {
    return y-h;
  }
  public float getY_High() {
    return y+h;
  }
  ...
  public void resume() {
    leftLock.resume();
    rightLock.resume();
    ui.getFirstPage().getPlot(1).setYearsMinMax(yearMin, yearMax);
    ui.getFirstPage().getPlot(2).setYearsMinMax(yearMin, yearMax);
  }
}
