...
class ys_FirstPage {
  ...
  public ys_FirstPage(float _w, float _y1, float _y2) {
    ...
    yearBtn = new ys_Button(YEAR_BUTTON_X, YEAR_BUTTON_Y, YEAR_BUTTON_W, YEAR_BUTTON_H, YEAR_BUTTON_TXT);
    tabularBtn = new ys_Button(TABULAR_BUTTON_X, TABULAR_BUTTON_Y, TABULAR_BUTTON_W, TABULAR_BUTTON_H, TABULAR_BUTTON_TXT);
    decadeBtn = new ys_Button(DECADE_BUTTON_X, DECADE_BUTTON_Y, DECADE_BUTTON_W, DECADE_BUTTON_H, DECADE_BUTTON_TXT);

    yBtn = new ys_Button(Y_BUTTON_X, Y_BUTTON_Y, Y_BUTTON_W, Y_BUTTON_H, Y_BUTTON_TXT);

    nextYearBtn = new ys_Button(NEXT_YEAR_BTN_X, NEXT_YEAR_BTN_Y, NEXT_YEAR_BTN_W, NEXT_YEAR_BTN_H, YEAR_PLUS_TXT);
    preYearBtn = new ys_Button(PRE_YEAR_BTN_X, PRE_YEAR_BTN_Y, PRE_YEAR_BTN_W, PRE_YEAR_BTN_H, YEAR_MINUS_TXT);
    nextDecadeBtn = new ys_Button(NEXT_DECADE_BTN_X, NEXT_DECADE_BTN_Y, NEXT_DECADE_BTN_W, NEXT_DECADE_BTN_H, DECADE_PLUS_TXT);
    preDecadeBtn = new ys_Button(PRE_DECADE_BTN_X, PRE_DECADE_BTN_Y, PRE_DECADE_BTN_W, PRE_DECADE_BTN_H, DECADE_MINUS_TXT);
